...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The batchCalculate001 recording.
    /// </summary>
    [TestModule("68ff2602-e1eb-473c-bd13-514ad6d06440", ModuleType.Recording, 1)]
    public partial class batchCalculate001 : ITestModule
    {
        /// <summary>
        ...
        static batchCalculate001 instance = new batchCalculate001();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public batchCalculate001()
        {
        }
        ...
        /// </summary>
        public static batchCalculate001 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '赵孕妇001' on item '筛查信息.孕妇姓名'.", repo.筛查信息.孕妇姓名Info, new RecordItemIndex(3));
            repo.筛查信息.孕妇姓名.Element.SetAttributeValue("Value", "赵孕妇001");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '231231232131232' on item '早期样本.早期样本号'.", repo.早期样本.早期样本号Info, new RecordItemIndex(8));
            repo.早期样本.早期样本号.Element.SetAttributeValue("Value", "231231232131232");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '44' on item '早期样本.CRL长度'.", repo.早期样本.CRL长度Info, new RecordItemIndex(11));
            repo.早期样本.CRL长度.Element.SetAttributeValue("Value", "44");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '44' on item '早期样本.体重'.", repo.早期样本.体重Info, new RecordItemIndex(12));
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '2' on item '早期样本.NT_E结果'.", repo.早期样本.NT_E结果Info, new RecordItemIndex(14));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item '早期样本.保存按钮' at Center.", repo.早期样本.保存按钮Info, new RecordItemIndex(17));
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Checked to 'true' on item '方案.早期血清'.", repo.方案.早期血清Info, new RecordItemIndex(19));
            repo.方案.早期血清.Element.SetAttributeValue("Checked", "true");
            Delay.Milliseconds(0);

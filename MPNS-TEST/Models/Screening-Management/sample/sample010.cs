...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The sample010 recording.
    /// </summary>
    [TestModule("f74cf269-b1f9-488b-8710-21c03f751acd", ModuleType.Recording, 1)]
    public partial class sample010 : ITestModule
    {
        /// <summary>
        ...
        static sample010 instance = new sample010();
        ...
        /// </summary>
        public static sample010 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item '早期样本.孕周类型' at Center.", repo.早期样本.孕周类型Info, new RecordItemIndex(8));
            repo.早期样本.孕周类型.Click();
            Delay.Milliseconds(0);

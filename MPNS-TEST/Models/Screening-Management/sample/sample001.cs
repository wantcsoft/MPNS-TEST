...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The sample001 recording.
    /// </summary>
    [TestModule("7d6073eb-7961-4f1b-88c1-f0d74d27d640", ModuleType.Recording, 1)]
    public partial class sample001 : ITestModule
    {
        /// <summary>
        ...
        static sample001 instance = new sample001();
        ...
        /// </summary>
        public static sample001 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '2018-08-21' on item '早期样本.采样日期'.", repo.早期样本.采样日期Info, new RecordItemIndex(9));
            repo.早期样本.采样日期.Element.SetAttributeValue("Value", "2018-08-21");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '2018-08-21' on item '早期样本.测试日期'.", repo.早期样本.测试日期Info, new RecordItemIndex(10));
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '2018-08-21' on item '早期样本.CRL日期'.", repo.早期样本.CRL日期Info, new RecordItemIndex(12));
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '3' on item '早期样本.孕周类型'.", repo.早期样本.孕周类型Info, new RecordItemIndex(14));
            repo.早期样本.孕周类型.Element.SetAttributeValue("TagValue", "3");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item '早期样本.保存按钮' at Center.", repo.早期样本.保存按钮Info, new RecordItemIndex(15));
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item '中期样本.新增中期样本' at Center.", repo.中期样本.新增中期样本Info, new RecordItemIndex(17));
            repo.中期样本.新增中期样本.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse scroll Vertical by -1000 units.", new RecordItemIndex(18));
            Mouse.ScrollWheel(-1000);
            Delay.Milliseconds(300);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse scroll Vertical by -1000 units.", new RecordItemIndex(19));
            Mouse.ScrollWheel(-1000);
            Delay.Milliseconds(300);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to 'YBH00010' on item '中期样本.中期样本号'.", repo.中期样本.中期样本号Info, new RecordItemIndex(20));
            repo.中期样本.中期样本号.Element.SetAttributeValue("Value", "YBH00010");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '2018-09-21' on item '中期样本.采样日期'.", repo.中期样本.采样日期Info, new RecordItemIndex(21));
            repo.中期样本.采样日期.Element.SetAttributeValue("Value", "2018-09-21");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '2018-09-21' on item '中期样本.测试日期'.", repo.中期样本.测试日期Info, new RecordItemIndex(22));
            repo.中期样本.测试日期.Element.SetAttributeValue("Value", "2018-09-21");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '44' on item '中期样本.体重'.", repo.中期样本.体重Info, new RecordItemIndex(23));

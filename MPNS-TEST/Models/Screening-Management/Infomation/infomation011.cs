...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The infomation011 recording.
    /// </summary>
    [TestModule("f5c829ba-6446-4800-87b5-4d99883542c5", ModuleType.Recording, 1)]
    public partial class infomation011 : ITestModule
    {
        /// <summary>
        /// Holds an instance of the global::MPNS_TEST.Repositorys.infomation.infomation011 repository.
        /// </summary>
        public static global::MPNS_TEST.Repositorys.infomation.infomation011 repo = global::MPNS_TEST.Repositorys.infomation.infomation011.Instance;

        static infomation011 instance = new infomation011();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public infomation011()
        {
        }
        ...
        /// </summary>
        public static infomation011 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '123456789012345678901' on item '筛查信息.联系电话'.", repo.筛查信息.联系电话Info, new RecordItemIndex(5));
            repo.筛查信息.联系电话.Element.SetAttributeValue("Value", "123456789012345678901");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '(null)' on item '筛查信息.联系电话'.", repo.筛查信息.联系电话Info, new RecordItemIndex(8));
            repo.筛查信息.联系电话.Element.SetAttributeValue("Value", null);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '12345678901234567890' with focus on '筛查信息.联系电话'.", repo.筛查信息.联系电话Info, new RecordItemIndex(9));
            repo.筛查信息.联系电话.PressKeys("12345678901234567890");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '(null)' on item '筛查信息.联系电话'.", repo.筛查信息.联系电话Info, new RecordItemIndex(11));
            repo.筛查信息.联系电话.Element.SetAttributeValue("Value", null);
            Delay.Milliseconds(0);

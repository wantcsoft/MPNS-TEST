...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit028 recording.
    /// </summary>
    [TestModule("34339e5f-b3bd-4ae4-8d02-535a406791c7", ModuleType.Recording, 1)]
    public partial class revisit028 : ITestModule
    {
        /// <summary>
        ...
        static revisit028 instance = new revisit028();
        ...
        /// </summary>
        public static revisit028 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable 脑突出状态.
        /// </summary>
        [TestVariable("153d6c55-b64e-4096-a8f3-65d7e9cd0069")]
        public string 脑突出状态
        {
            get { return _脑突出状态; }
            set { _脑突出状态 = value; }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Checked' from item '筛查回访.脑突出' and assigning its value to variable '脑突出状态'.", repo.筛查回访.脑突出Info, new RecordItemIndex(8));
            脑突出状态 = repo.筛查回访.脑突出.Element.GetAttributeValueText("Checked");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", 脑突出状态, new RecordItemIndex(9));

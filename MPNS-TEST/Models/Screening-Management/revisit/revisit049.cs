...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit049 recording.
    /// </summary>
    [TestModule("744e1b74-d5f2-4e15-a52b-231f717cdcef", ModuleType.Recording, 1)]
    public partial class revisit049 : ITestModule
    {
        /// <summary>
        ...
        static revisit049 instance = new revisit049();
        ...
        /// </summary>
        public static revisit049 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item '筛查回访.N42天' at Center.", repo.筛查回访.N42天Info, new RecordItemIndex(0));
            repo.筛查回访.N42天.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Delay", "Waiting for 300ms.", new RecordItemIndex(1));
            Delay.Duration(300, false);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '' on item '筛查回访.N42天'.", repo.筛查回访.N42天Info, new RecordItemIndex(2));
            repo.筛查回访.N42天.Element.SetAttributeValue("TagValue", "");
            Delay.Milliseconds(0);

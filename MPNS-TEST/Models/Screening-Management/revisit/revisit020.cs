...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit020 recording.
    /// </summary>
    [TestModule("ca4a3106-3f51-4316-a818-e8e21b8ba72a", ModuleType.Recording, 1)]
    public partial class revisit020 : ITestModule
    {
        /// <summary>
        ...
        static revisit020 instance = new revisit020();
        ...
        /// </summary>
        public static revisit020 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable 小头状态.
        /// </summary>
        [TestVariable("c75ed2ba-4c9f-41fb-8451-1b59cac69612")]
        public string 小头状态
        {
            get { return _小头状态; }
            set { _小头状态 = value; }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Checked' from item '筛查回访.小头' and assigning its value to variable '小头状态'.", repo.筛查回访.小头Info, new RecordItemIndex(8));
            小头状态 = repo.筛查回访.小头.Element.GetAttributeValueText("Checked");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", 小头状态, new RecordItemIndex(9));

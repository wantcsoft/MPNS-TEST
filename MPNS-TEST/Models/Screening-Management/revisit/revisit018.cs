...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit018 recording.
    /// </summary>
    [TestModule("282d45a2-20e8-4958-b857-a0d9403ad1f7", ModuleType.Recording, 1)]
    public partial class revisit018 : ITestModule
    {
        /// <summary>
        ...
        static revisit018 instance = new revisit018();
        ...
        /// </summary>
        public static revisit018 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable 耳结构异常状态.
        /// </summary>
        [TestVariable("e8037795-7c0b-4fa4-8dff-f6158f8adb4e")]
        public string 耳结构异常状态
        {
            get { return _耳结构异常状态; }
            set { _耳结构异常状态 = value; }
        }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Checked' from item '筛查回访.耳结构异常' and assigning its value to variable '耳结构异常状态'.", repo.筛查回访.耳结构异常Info, new RecordItemIndex(8));
            耳结构异常状态 = repo.筛查回访.耳结构异常.Element.GetAttributeValueText("Checked");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", 耳结构异常状态, new RecordItemIndex(9));

...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit025 recording.
    /// </summary>
    [TestModule("39cc6109-b613-49e8-a259-08f3fba6cef7", ModuleType.Recording, 1)]
    public partial class revisit025 : ITestModule
    {
        /// <summary>
        ...
        static revisit025 instance = new revisit025();
        ...
        /// </summary>
        public static revisit025 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable 小指弯曲状态.
        /// </summary>
        [TestVariable("62d11ce5-9067-4e1d-af98-e474c0803bb4")]
        public string 小指弯曲状态
        {
            get { return _小指弯曲状态; }
            set { _小指弯曲状态 = value; }
        }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Checked' from item '筛查回访.小指弯曲' and assigning its value to variable '小指弯曲状态'.", repo.筛查回访.小指弯曲Info, new RecordItemIndex(8));
            小指弯曲状态 = repo.筛查回访.小指弯曲.Element.GetAttributeValueText("Checked");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", 小指弯曲状态, new RecordItemIndex(9));

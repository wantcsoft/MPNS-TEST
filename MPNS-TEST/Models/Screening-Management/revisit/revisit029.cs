...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit029 recording.
    /// </summary>
    [TestModule("5393c1d9-f409-447d-a341-919c95dd7785", ModuleType.Recording, 1)]
    public partial class revisit029 : ITestModule
    {
        /// <summary>
        ...
        static revisit029 instance = new revisit029();
        ...
        /// </summary>
        public static revisit029 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable 脊柱裂状态.
        /// </summary>
        [TestVariable("06576d37-4922-4ef3-8307-c04f94ffd7e2")]
        public string 脊柱裂状态
        {
            get { return _脊柱裂状态; }
            set { _脊柱裂状态 = value; }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Checked' from item '筛查回访.脊柱裂' and assigning its value to variable '脊柱裂状态'.", repo.筛查回访.脊柱裂Info, new RecordItemIndex(8));
            脊柱裂状态 = repo.筛查回访.脊柱裂.Element.GetAttributeValueText("Checked");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", 脊柱裂状态, new RecordItemIndex(9));

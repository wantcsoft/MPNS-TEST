...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit011 recording.
    /// </summary>
    [TestModule("70f367aa-094f-489c-a1f3-6ef2c4021ff4", ModuleType.Recording, 1)]
    public partial class revisit011 : ITestModule
    {
        /// <summary>
        ...
        static revisit011 instance = new revisit011();
        ...
        /// </summary>
        public static revisit011 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '' on item '筛查回访.ONTD实际结果'.", repo.筛查回访.ONTD实际结果Info, new RecordItemIndex(8));
            repo.筛查回访.ONTD实际结果.Element.SetAttributeValue("TagValue", "");
            Delay.Milliseconds(0);

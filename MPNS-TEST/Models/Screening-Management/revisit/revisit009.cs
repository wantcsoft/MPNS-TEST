...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit009 recording.
    /// </summary>
    [TestModule("2f42dcc2-c859-4c6a-9745-749799929bb6", ModuleType.Recording, 1)]
    public partial class revisit009 : ITestModule
    {
        /// <summary>
        ...
        static revisit009 instance = new revisit009();
        ...
        /// </summary>
        public static revisit009 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '' on item '筛查回访.N21三体实际结果'.", repo.筛查回访.N21三体实际结果Info, new RecordItemIndex(8));
            repo.筛查回访.N21三体实际结果.Element.SetAttributeValue("TagValue", "");
            Delay.Milliseconds(0);

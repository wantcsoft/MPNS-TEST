...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit030 recording.
    /// </summary>
    [TestModule("54a7e4cf-a77b-4770-b6ad-2276a4c2546b", ModuleType.Recording, 1)]
    public partial class revisit030 : ITestModule
    {
        /// <summary>
        ...
        static revisit030 instance = new revisit030();
        ...
        /// </summary>
        public static revisit030 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '(null)' on item '筛查回访.回访人'.", repo.筛查回访.回访人Info, new RecordItemIndex(8));
            repo.筛查回访.回访人.Element.SetAttributeValue("Value", null);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '123456789012345678901234567890' with focus on '筛查回访.回访人'.", repo.筛查回访.回访人Info, new RecordItemIndex(9));
            repo.筛查回访.回访人.PressKeys("123456789012345678901234567890");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '(null)' on item '筛查回访.回访人'.", repo.筛查回访.回访人Info, new RecordItemIndex(12));
            repo.筛查回访.回访人.Element.SetAttributeValue("Value", null);
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item '筛查回访.保存' at Center.", repo.筛查回访.保存Info, new RecordItemIndex(13));
            repo.筛查回访.保存.Click();
            Delay.Milliseconds(0);

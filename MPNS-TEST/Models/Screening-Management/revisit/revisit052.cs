...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit052 recording.
    /// </summary>
    [TestModule("3cd4455b-cd5b-4584-b551-23c0e4da23bb", ModuleType.Recording, 1)]
    public partial class revisit052 : ITestModule
    {
        /// <summary>
        ...
        static revisit052 instance = new revisit052();
        ...
        /// </summary>
        public static revisit052 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item '筛查回访.关节曲度' at Center.", repo.筛查回访.关节曲度Info, new RecordItemIndex(0));
            repo.筛查回访.关节曲度.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Delay", "Waiting for 300ms.", new RecordItemIndex(1));
            Delay.Duration(300, false);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '' on item '筛查回访.关节曲度'.", repo.筛查回访.关节曲度Info, new RecordItemIndex(2));
            repo.筛查回访.关节曲度.Element.SetAttributeValue("TagValue", "");
            Delay.Milliseconds(0);

...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit027 recording.
    /// </summary>
    [TestModule("042cadbc-3ef1-4cc9-9ecb-3709a0bd069f", ModuleType.Recording, 1)]
    public partial class revisit027 : ITestModule
    {
        /// <summary>
        ...
        static revisit027 instance = new revisit027();
        ...
        /// </summary>
        public static revisit027 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable 无脸儿状态.
        /// </summary>
        [TestVariable("a0cc8e3b-9122-47e9-81ad-785fe46be2a9")]
        public string 无脸儿状态
        {
            get { return _无脸儿状态; }
            set { _无脸儿状态 = value; }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Checked' from item '筛查回访.无脸儿' and assigning its value to variable '无脸儿状态'.", repo.筛查回访.无脸儿Info, new RecordItemIndex(8));
            无脸儿状态 = repo.筛查回访.无脸儿.Element.GetAttributeValueText("Checked");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", 无脸儿状态, new RecordItemIndex(9));

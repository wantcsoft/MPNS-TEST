...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit021 recording.
    /// </summary>
    [TestModule("77aa8b73-6781-480d-947b-a3c78d0f78f5", ModuleType.Recording, 1)]
    public partial class revisit021 : ITestModule
    {
        /// <summary>
        ...
        static revisit021 instance = new revisit021();
        ...
        /// </summary>
        public static revisit021 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable 扁平脸状态.
        /// </summary>
        [TestVariable("c1b83e89-b1f5-4ff5-a15d-4764b90f03b2")]
        public string 扁平脸状态
        {
            get { return _扁平脸状态; }
            set { _扁平脸状态 = value; }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Checked' from item '筛查回访.扁平脸' and assigning its value to variable '扁平脸状态'.", repo.筛查回访.扁平脸Info, new RecordItemIndex(8));
            扁平脸状态 = repo.筛查回访.扁平脸.Element.GetAttributeValueText("Checked");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", 扁平脸状态, new RecordItemIndex(9));

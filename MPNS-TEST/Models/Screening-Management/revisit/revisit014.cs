...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit014 recording.
    /// </summary>
    [TestModule("acadcc61-e379-4ccb-9b2f-0348571889b9", ModuleType.Recording, 1)]
    public partial class revisit014 : ITestModule
    {
        /// <summary>
        ...
        static revisit014 instance = new revisit014();
        ...
        /// </summary>
        public static revisit014 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '' on item '筛查回访.处理结果'.", repo.筛查回访.处理结果Info, new RecordItemIndex(8));
            repo.筛查回访.处理结果.Element.SetAttributeValue("TagValue", "");
            Delay.Milliseconds(0);

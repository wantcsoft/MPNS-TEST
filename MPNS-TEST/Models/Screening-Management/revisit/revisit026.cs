...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit026 recording.
    /// </summary>
    [TestModule("e0d402a7-1057-4f5a-ad10-17c3be337b2d", ModuleType.Recording, 1)]
    public partial class revisit026 : ITestModule
    {
        /// <summary>
        ...
        static revisit026 instance = new revisit026();
        ...
        /// </summary>
        public static revisit026 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable 神经管缺陷异常状态.
        /// </summary>
        [TestVariable("2f241dde-2fed-40ce-9883-21edab161f7a")]
        public string 神经管缺陷异常状态
        {
            get { return _神经管缺陷异常状态; }
            set { _神经管缺陷异常状态 = value; }
        }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Checked' from item '筛查回访.神经管缺陷异常' and assigning its value to variable '神经管缺陷异常状态'.", repo.筛查回访.神经管缺陷异常Info, new RecordItemIndex(8));
            神经管缺陷异常状态 = repo.筛查回访.神经管缺陷异常.Element.GetAttributeValueText("Checked");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", 神经管缺陷异常状态, new RecordItemIndex(9));

...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit047 recording.
    /// </summary>
    [TestModule("0367023f-b320-4986-8391-6c2920118bb4", ModuleType.Recording, 1)]
    public partial class revisit047 : ITestModule
    {
        /// <summary>
        ...
        static revisit047 instance = new revisit047();
        ...
        /// </summary>
        public static revisit047 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item '筛查回访.听力测试' at Center.", repo.筛查回访.听力测试Info, new RecordItemIndex(0));
            repo.筛查回访.听力测试.Click();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Delay", "Waiting for 300ms.", new RecordItemIndex(1));
            Delay.Duration(300, false);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute TagValue to '' on item '筛查回访.听力测试'.", repo.筛查回访.听力测试Info, new RecordItemIndex(2));
            repo.筛查回访.听力测试.Element.SetAttributeValue("TagValue", "");
            Delay.Milliseconds(0);

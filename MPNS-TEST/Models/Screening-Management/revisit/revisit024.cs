...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The revisit024 recording.
    /// </summary>
    [TestModule("c76aecda-ea39-4774-b48b-ed094cf5d641", ModuleType.Recording, 1)]
    public partial class revisit024 : ITestModule
    {
        /// <summary>
        ...
        static revisit024 instance = new revisit024();
        ...
        /// </summary>
        public static revisit024 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable 手指异常状态.
        /// </summary>
        [TestVariable("ec203881-ebbf-4b47-84be-991c467194a0")]
        public string 手指异常状态
        {
            get { return _手指异常状态; }
            set { _手指异常状态 = value; }
        }
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Get Value", "Getting attribute 'Checked' from item '筛查回访.手指异常' and assigning its value to variable '手指异常状态'.", repo.筛查回访.手指异常Info, new RecordItemIndex(8));
            手指异常状态 = repo.筛查回访.手指异常.Element.GetAttributeValueText("Checked");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "User", 手指异常状态, new RecordItemIndex(9));

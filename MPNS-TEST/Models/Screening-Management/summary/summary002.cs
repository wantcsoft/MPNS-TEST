...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The summary002 recording.
    /// </summary>
    [TestModule("b0d095bb-d0be-4f26-845f-010097b17db3", ModuleType.Recording, 1)]
    public partial class summary002 : ITestModule
    {
        /// <summary>
        ...
        static summary002 instance = new summary002();
        ...
        /// </summary>
        public static summary002 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to 'MOZ00001' on item '汇总信息.搜索框'.", repo.汇总信息.搜索框Info, new RecordItemIndex(3));
            repo.汇总信息.搜索框.Element.SetAttributeValue("Value", "MOZ00001");
            Delay.Milliseconds(0);

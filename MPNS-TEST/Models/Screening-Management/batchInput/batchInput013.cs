...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The batchInput013 recording.
    /// </summary>
    [TestModule("0be894e6-9056-4b9d-9a67-3afa5ce22842", ModuleType.Recording, 1)]
    public partial class batchInput013 : ITestModule
    {
        /// <summary>
        ...
        static batchInput013 instance = new batchInput013();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public batchInput013()
        {
        }
        ...
        /// </summary>
        public static batchInput013 Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '李孕妇' on item '筛查信息.孕妇姓名'.", repo.筛查信息.孕妇姓名Info, new RecordItemIndex(3));
            repo.筛查信息.孕妇姓名.Element.SetAttributeValue("Value", "李孕妇");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '310105199901040004' on item '筛查信息.身份证号'.", repo.筛查信息.身份证号Info, new RecordItemIndex(4));
            repo.筛查信息.身份证号.Element.SetAttributeValue("Value", "310105199901040004");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '00014' on item '中期样本.中期样本号'.", repo.中期样本.中期样本号Info, new RecordItemIndex(9));
            repo.中期样本.中期样本号.Element.SetAttributeValue("Value", "00014");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '2019/11/04' on item '筛查管理批量录入.开始日期'.", repo.筛查管理批量录入.开始日期Info, new RecordItemIndex(21));
            repo.筛查管理批量录入.开始日期.Element.SetAttributeValue("Value", "2019/11/04");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Set value", "Setting attribute Value to '2019/11/04' on item '筛查管理批量录入.结束日期'.", repo.筛查管理批量录入.结束日期Info, new RecordItemIndex(22));
            repo.筛查管理批量录入.结束日期.Element.SetAttributeValue("Value", "2019/11/04");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Mouse", "Mouse Left Click item '筛查管理批量录入.确定导入' at Center.", repo.筛查管理批量录入.确定导入Info, new RecordItemIndex(27));
